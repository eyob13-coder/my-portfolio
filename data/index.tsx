import { FaCode, FaGithub, FaLinkedin, FaTwitter, FaLightbulb, FaRocket, FaReact, FaNodeJs, FaGit, FaDocker, FaAws, FaCss3, FaHome, FaUser, FaBriefcase, FaTools, FaCommentDots, FaEnvelope } from 'react-icons/fa';

export const navItems = [
  { name: "Entrance", link: "#hero", icon: <FaHome /> },
  { name: "Chamber", link: "#about", icon: <FaUser /> },
  { name: "Case Files", link: "#projects", icon: <FaBriefcase /> },
  { name: "Mastery", link: "#skills", icon: <FaTools /> },
  { name: "Echoes", link: "#testimonials", icon: <FaCommentDots /> },
  { name: "Exit Door", link: "#contact", icon: <FaEnvelope /> },
];
